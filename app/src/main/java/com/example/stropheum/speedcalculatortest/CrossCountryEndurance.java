...
public class CrossCountryEndurance extends ActionBarActivity {

    // Allow 15 seconds of error for time calculations
    final double MILE_TIME_ERROR = 0.25;

    // Goal mile times for each part
    final double PART_ONE_GOAL_PACE   = 9.0;
    final double PART_TWO_GOAL_PACE   = 10.0;
    final double PART_THREE_GOAL_PACE = 11.0;
    final double PART_FOUR_GOAL_PACE  = 12.0;
    final double PART_FIVE_GOAL_PACE  = 13.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cross_country_endurance);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cross_country_endurance, menu);
        return true;
    }
    ...
    public void onBackPressed() {
        ...
        stopService(new Intent(CrossCountryEndurance.this, SpeedCalculationService.class));
